...
PLAYLIST = 'PLqILQSyq0LeiWwiGHpgI3NO_aNbTpDhoX' # All songs
# PLAYLIST = 'PLqILQSyq0LehIneD7MdGhpdxoLfe61xiK' # New Songs
...
result = ytmusic.add_playlist_items(PLAYLIST, new_ids_to_be_added , None, False)
print("Status: ", result)
